...
from multilayer_optical_network.model.plan import apply_op, TeardownLightpath, service_oms_sequence
from multilayer_optical_network.model.views import services_dict
from multilayer_optical_network.model.ip_routing import build_grooming_map
from multilayer_optical_network.model.exposure import compute_exposure
from multilayer_optical_network.model.objective import evaluate_objective
from multilayer_optical_network.model.validate import validate_plan
...
def _model_with_dangling_working_leg() -> NetworkModel:
    ...
    Built on multilayer_optical_network.testing's synthesizable-topology helpers
    ...
    directions, which (per multilayer_optical_network.testing's module docstring,
